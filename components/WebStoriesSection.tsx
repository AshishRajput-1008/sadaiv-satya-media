...
const BollywoodReels = () => {
  ...
  const videos = [
    {
      ...
      videoSrc: 'https://videos.bhaskarassets.com/thumb/256x0/2026/01/14/nupur_1768366249/mp4/v360.mp4',
      duration: '0:49',
      hasVideo: true
    },
    {
      ...
      videoSrc: 'https://videos.bhaskarassets.com/thumb/256x0/2026/01/13/amir-khan_1768317072/mp4/v360.mp4',
      duration: '1:47',
      hasVideo: true
    },
    {
      ...
      videoSrc: 'https://videos.bhaskarassets.com/thumb/256x0/2026/01/13/samar-hazarika_1768298086/mp4/v360.mp4',
      duration: '0:57',
      hasVideo: true
    },
    {
      ...
      videoSrc: 'https://videos.bhaskarassets.com/thumb/256x0/2026/01/13/01-o-romeo-controversy1_1768310771/mp4/v360.mp4',
      duration: '0:40',
      hasVideo: true
    },
    {
      ...
      videoSrc: 'https://videos.bhaskarassets.com/thumb/256x0/2026/01/13/border-2-sunil-update_1768280477/mp4/v360.mp4',
      duration: '1:39',
      hasVideo: true
    },
    {
  ...
  const handleVideoHover = (e, isEntering) => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto bg-white p-1 pl-0 rounded-lg">
      {/* Header */}
      <div className="flex justify-between items-center mb-4 md:mb-6">
        <h2 className="text-[18px] ml-4 sm:text-[24px] md:text-[28px] font-bold text-[#1a1a1a]">
          बॉलीवुड REEL
        </h2>
         
        <a
          href="/videos/gallery?type=widget&vid=13"
          className="text-[#FF6B35] no-underline mr-4 text-[12px] sm:text-sm font-semibold px-3 sm:px-5 py-1.5 sm:py-2 border border-[#FF6B35] rounded transition-all duration-300 hover:bg-[#FF6B35] hover:text-white"
        >
          सभी देखें
        </a>
      </div>
        ...
        >
          {videos.map((video, index) => (
            ...
            >
              ...
              >
                {video.hasVideo && <source src={video.videoSrc} type="video/mp4" />}
              </video>
              ...
              {/* <div className="absolute top-2 left-2 right-2 z-20">
                <h3 className="text-white text-[11px] md:text-sm font-semibold leading-tight m-0 line-clamp-3 drop-shadow-lg">
                  {video.title}
                </h3>
              </div> */}
